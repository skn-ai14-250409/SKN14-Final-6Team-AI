-- Active: 1753665102208@@127.0.0.1@3306@qook_chatbot
...
('premium', '회원', '{"features": ["무료배송", "우선 고객지원", "5% 할인"]}', 9900, 0.05, 0),
('gold', '골드 회원', '{"features": ["무료배송", "VIP 고객지원", "10% 할인", "신상품 우선 구매"]}', 19900, 0.10, 0);
